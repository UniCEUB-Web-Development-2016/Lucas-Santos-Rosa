...
if (isset($_POST['submitted'])) { // Check if the form has been submitted.
	...
	if (isset($_GET['shAllP'])){
		$campos = "../listRegister.php";
	}
	if (isset($_GET['shAllS'])){
		$campos = "../listServices.php";
	}
	if (isset($_GET['delProd'])){
		$campos = "../deleteProduct.php";
	}
	if (isset($_GET['delServ'])){
		$campos = "../deleteService.php";
	}
      ...
      <div class="row">
        <div class="col-md-4">
          <h2>Options</h2>
				...
				<form class="form-signin">
					<button class="btn btn-block" type="submit">All Products</button><input type="hidden" name="shAllP" value="TRUE" />
				</form>
				<form class="form-signin">
					<button class="btn btn-block" type="submit">All Services</button><input type="hidden" name="shAllS" value="TRUE" />
				</form>
				<form class="form-signin">
					<button class="btn btn-block" type="submit">Delete Products</button><input type="hidden" name="delProd" value="TRUE" />
				</form>
				<form class="form-signin">
					<button class="btn btn-block" type="submit">Delete Services</button><input type="hidden" name="delServ" value="TRUE" />
				</form>
				<form class="form-signin">
